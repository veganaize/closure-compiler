...
## Apache Ivy:
      ...
      <dependency org="com.google.javascript" name="closure-compiler" rev="v20140407"/>

## Groovy Grape:

      @Grapes(
          @Grab(group='com.google.javascript', module='closure-compiler', version='v20140407')
      )

## Apache Buildr

      'com.google.javascript:closure-compiler:jar:v20140407'
